...
function ArraySort() {
  ...
  const reverseSorted = x.slice().sort((a, b) => b - a);
  console.log(reverseSorted);

  const sortedByPages = x.slice().sort((a, b) => b.pages - a.pages);
  console.log(sortedByPages);
}

/**
 * ******************************************
 * Immutable Arrays 不可变数组
 * ******************************************
 */
 ...
 * ******************************************
 */
function AsynchronousJavaScriptPromise() {
 ...
 * ******************************************
 */
function AsynchronousJavaScriptAsyncAwait() {
